...
auth_channel = environ.get('https://t.me/+KTejLxDdoX9hN2Q1')
auth_grp = environ.get("AUTH_GROUP")
AUTH_CHANNEL = "https://t.me/+KTejLxDdoX9hN2Q1"
...
BUTTON_LOCK_TEXT = environ.get("BUTTON_LOCK_TEXT", "⚠️ Hey {query}!  File nyn tharilla ;)")
FORCE_SUB_TEXT = environ.get('FORCE_SUB_TEXT', '𝑱𝒐𝒊𝒏 𝑶𝒖𝒓 𝑴𝒐𝒗𝒊𝒆 𝑼𝒑𝒅𝒂𝒕𝒆𝒔 𝑪𝒉𝒂𝒏𝒏𝒆𝒍 𝑻𝒐 𝑼𝒔𝒆 𝑻𝒉𝒊𝒔 𝑩𝒐𝒕!')
RemoveBG_API = environ.get("RemoveBG_API", "")
WELCOM_PIC = environ.get("WELCOM_PIC", "")
WELCOM_TEXT = environ.get("WELCOM_TEXT", "Hai {user}\nWelcome to {chat}.\n\nJoin @Filmcognito for latest film updates 🙂")
