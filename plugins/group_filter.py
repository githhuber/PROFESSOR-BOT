...
async def advantage_spell_chok(msg):
    ...
    gs_parsed = []
    if not g_s:
        k = await msg.reply("I couldn't find any movie in that name.","Check your spelling on https://www.google.com/search 🤌","Or check if it's available on ott...🫠",sep="/n")
    ...
    if not movielist:
        k = await msg.reply("I couldn't find anything related to that.","Check your spelling on https://www.google.com/search 🤌"," Or check if it's available on ott...🫠",sep="/n")
        await asyncio.sleep(8)
        await k.delete()
        return
