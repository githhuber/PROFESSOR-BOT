...
async def advantage_spell_chok(msg):
    ...
    gs_parsed = []
    if not g_s:
        k = await msg.reply("I couldn't find any movie in that name./nCheck your spelling on https://www.google.com/search 🤌 /nOr check if it's available on ott...🫠")
    ...
    if not movielist:
        k = await msg.reply("I couldn't find anything related to that. /nCheck your spelling on https://www.google.com/search 🤌 /nOr check if it's available on ott...🫠")
        await asyncio.sleep(8)
        await k.delete()
        return
