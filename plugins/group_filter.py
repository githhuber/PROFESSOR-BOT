...
async def advantage_spell_chok(msg):
    ...
    gs_parsed = []
    if not g_s:
        k = await msg.reply("I couldn't find any movie in that name. /n Check your spelling or check if it's available on ott...🫠")
    ...
    if not movielist:
        k = await msg.reply("I couldn't find anything related to that. /n Check your spelling or it will not be released on ott yet...")
        await asyncio.sleep(8)
        await k.delete()
        return
